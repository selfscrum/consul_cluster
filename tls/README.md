...
This module has been taken from the [terraform-aws-vault](https://github.com/hashicorp/terraform-aws-vault) project and is licensed under Apache-2.0, see [LINCENSE](./LICENSE.md)

I modified the `variables.tf` file to prepopulate the *.pem destinations.
